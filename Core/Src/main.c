...
uint8_t synthetic_data[DATA_BYTES];
/* USER CODE END PV */
...
int main(void)
{
  ...
  // Obrada podataka iz imu_data.h fajla
//  for(uint32_t i = 0; i < IMU_DATA_SAMPLES; i++)
//  {
//	  gx = gyro_struct[i].x/IMU_SCALE;
//	  gy = gyro_struct[i].y/IMU_SCALE;
//	  gz = gyro_struct[i].z/IMU_SCALE;
//
//	  ax = accel_struct[i].x/IMU_SCALE;
//	  ay = accel_struct[i].y/IMU_SCALE;
//	  az = accel_struct[i].z/IMU_SCALE;
//
//	  ekf_predict(1/(float)IMU_HZ, gx, gy, gz);
